 ...
 <div id="français" class="w3-container city"  style="display:none">
   ...
   <button onclick="myFunction('Demo6')" class="w3-button w3-block w3-white w3-left-align"><p id="para2">📁Vocabulaire /  Kelime Haznesi</p></button>
    ...
    <div id="protectedContent" style="display: none;">
        <p id="para6">📁 Divers</p>
        <ul>
            <li><a href="tr/Exemple-Vater_und_Sohn.pdf" dowload="" target="_blank"><p id="para4">📄 <i>  Exemple - Vater und Sohn / Baba ve Oğul</i></p></a></li>
            <li><a href="fr/telafuz/Mon_Cahier_de_math.pdf" dowload="" target="_blank"><p id="para4">📄  Cahier de math</p></a></li>
            <li><a href="fr/grm/sujet-tonique_correction.pdf" dowload="" target="_blank"><p id="para4">📄 Correction- sujets-toniques </p></a></li>
